...
AZURE_VISION_DEPLOYMENT_NAME = os.getenv("AZURE_VISION_DEPLOYMENT_NAME")
...
MAX_CONCURRENT_EMBEDDINGS = int(os.getenv("MAX_CONCURRENT_EMBEDDINGS", "100"))
MAX_CONCURRENT_IMAGE_CAPTIONS = int(os.getenv("MAX_CONCURRENT_IMAGE_CAPTIONS", "10"))
